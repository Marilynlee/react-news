...
import {Icon, List, message, Tabs, Upload} from "antd";
...
export default class MobileUserCenter extends React.Component {
    ...
    render() {
        ...
        const collectionCount = userCollection.length ? userCollection.length : 0;
        ...
        const commentsCount = userComments.length ? userComments.length : 0;
            ...
            <div>
                ...
                <Tabs>
                    <TabPane tab="收藏列表" key="1">
                        <div className="comment">{userCollectionList}</div>
                    </TabPane>
